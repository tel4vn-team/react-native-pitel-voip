...
- **Export the .p12 file and config in [pitel portal](https://github.com/tel4vn-team/react-native-pitel-voip/blob/main/docs/PORTAL_GUIDE.md)**
...
> - Please check [PORTAL_GUIDE.md](https://github.com/tel4vn-team/react-native-pitel-voip/blob/main/docs/PORTAL_GUIDE.md) to setup your config.
